					...
					<div className="w-3/4 mx-auto px-4 flex items-center h-auto">
						<div className="-mx-4 flex flex-wrap">
							...
							<div className="w-full flex flex-col p-4 w-full xl:w-1/2 nice-cursor">
								...
								<div
									className="mt-5 text-black dark:text-white flex-1 px-5 py-6 rounded-lg shadow-lg sm:h-1/4 md:h-full bg-sky-light dark:bg-grey-dark hover:bg-sky-dark dark:hover:bg-blue-light transition duration-300"
									onClick={() => setCurrent(<Skills />)}
								>
