        ...
        <div class="md:grid md:grid-cols-2 lg:divide-x md:divide-y-8 divide-none visible">
            <div class="w-3/4 mx-auto px-4 flex items-center lg:h-screen md:h-auto">
                <div class="-mx-4 flex flex-wrap">
                    <div class="w-full flex flex-col p-4 sm:w-full lg:w-full">
                        <div class="flex-1 px-5 py-6 rounded-lg shadow-lg sm:h-1/4 md:h-1/4 bg-grey-dark object-contain hover:bg-blue-light transition duration-300"
                    ...
                    <div class="w-full flex flex-col p-4 md:w-full lg:w-1/2">
                        <div class="flex-1 px-5 py-6 rounded-lg shadow-lg sm:h-1/4 md:h-full bg-grey-dark hover:bg-blue-light transition duration-300 align-middle my">
                            <p class="text-4xl">
